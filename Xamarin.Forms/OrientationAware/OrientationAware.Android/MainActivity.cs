...
namespace OrientationAware.Droid
{
    [Activity(Label = "OrientationAware", Icon = "@drawable/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
